...
|-----|------|-------|--------|
| 53 | 2026-08-13 | High-cardinality time-series metrics at scale: Uber M3's 500M metrics/sec ingest and quorum-replicated M3DB, Facebook's Gorilla in-memory compression (2B+ series, 10-12x smaller), the 3-4KB-per-series cardinality bomb that silently OOMs ingesters, and the cascading-rebalance metastable failure it triggers | [lesson](lessons/053-time-series-metrics-cardinality-at-scale.md) |
