...
|-----|------|-------|--------|
| 53 | 2026-08-11 | Real-time leaderboards at scale: why "ORDER BY score DESC" dies under high-frequency concurrent writes, Redis-style sorted sets (skip list + hash table, O(log N) rank/update) for Peloton's 32,000+ rider Turkey Burn leaderboard, cohort sharding to a fixed small N (Duolingo's 30-person leagues), and batch settlement for exact fairness (Codeforces' post-contest Elo recompute) | [lesson](lessons/053-realtime-leaderboards-at-scale.md) |
