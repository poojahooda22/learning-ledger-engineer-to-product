...
|-----|------|-------|--------|
| 53 | 2026-08-12 | Ledger correctness under extreme write concurrency: the single-writer, lock-free "mechanical sympathy" pattern LMAX Exchange built for its trading engine in 2011 (the Disruptor), and how TigerBeetle generalized it into a distributed double-entry accounting database that solves the "hot account" problem capping ordinary databases at roughly 100 transfers a second against any one account | [lesson](lessons/053-ledger-correctness-single-writer-lmax-tigerbeetle.md) |
